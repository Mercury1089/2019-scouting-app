...
public class Settings extends MainActivity {
    ...
    public void saveClick (View view) {
        ...
        String FirstAllianceParterLocal = "" + getFirstAlliancePartner();
        ...
        String SendMessage = leftOrRight + ScouterNameLocal + "+" + MatchNumberLocal + TeamNumberLocal + FirstAllianceParterLocal + SecondAlliancePartnerLocal + NoShowStatusLocal + IsBlueAllianceLocal + IsRedAllianceLocal + IsSetupPanelLocal + IsCargoPanelLocal + StartL1Local + StartC1Local + StartR1Local + StartL2Local + StartR2Local;
        ...
        if (isLocalStorageClicked) {
            ...
            //using getters to retain previous settings
